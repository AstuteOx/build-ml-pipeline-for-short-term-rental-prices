...
def go(args):
    ...
    # Download trainval dataset from wandb
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # Add exported model to artifact
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    # Create pipeline for pre porcessing
